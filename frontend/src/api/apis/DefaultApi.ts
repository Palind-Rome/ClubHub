...
export class DefaultApi extends runtime.BaseAPI {
  ...
  /**
   * 社团负责人、干部或指导老师可以为本社团创建课程，并选择面向本社团或全校开放。
   * 发布或保存培训课程
   */
  ...
  /**
   * 登录用户按课程开放范围查看课程；发布者和本社团管理者可查看并管理草稿课程。
   * 获取培训课程列表
   */
  ...
  /**
   * 用户可查看自己的学习记录；社团管理者后续可查看本社团课程学习记录。
   * 查询学习记录
   */
  ...
  /**
   * 课程发布者按社团上下文获取正常状态的教师或指导老师账号，供课程表单按姓名、学号或工号选择。
   * 获取可选授课教师
   */
  ...
  /**
   * 课程发布者或本社团负责人、干部、指导老师可修改课程信息、开放范围和发布状态。
   * 修改培训课程
   */
  ...
  /**
   * 用户只能更新自己的学习记录；进度达到 100 时写入完成时间。
   * 更新学习进度
   */
