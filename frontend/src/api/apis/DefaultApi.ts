...
export class DefaultApi extends runtime.BaseAPI {
  ...
  /**
   * 系统管理员、本社团负责人或指导老师可以为成员新增职位任期；新增任期时可关闭该成员此前开始且与新任期重叠的有效任期以保留历史记录。同一成员在同一社团不得重复创建同名任期，选择关闭旧任期时也不得用更早或同日起始的新记录覆盖已有任期。
   * 新增社团成员或干部任期
   */
  ...
  /**
   * 系统管理员、社团管理员、本社团负责人、干部、成员和指导老师可以只读查看成员及任期；默认返回状态有效且尚未到期的当前或未来任期，可选择包含历史记录，并可按届、部门或小组筛选。社团管理员不参与内部任期维护。
   * 查询社团成员与干部任期记录
   */
