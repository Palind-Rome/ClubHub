 ...
 */
export function instanceOfCreateClubApplicationRequest(value: object): value is CreateClubApplicationRequest {
...
export function CreateClubApplicationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateClubApplicationRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateClubApplicationRequestToJSONTyped(value?: CreateClubApplicationRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
