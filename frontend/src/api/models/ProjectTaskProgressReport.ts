...
export type ProjectTaskProgressReportTaskStatusEnum = typeof ProjectTaskProgressReportTaskStatusEnum[keyof typeof ProjectTaskProgressReportTaskStatusEnum];


/**
 * Check if a given object implements the ProjectTaskProgressReport interface.
 */
export function instanceOfProjectTaskProgressReport(value: object): value is ProjectTaskProgressReport {
...
export function ProjectTaskProgressReportFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProjectTaskProgressReport {
    if (json == null) {
        return json;
    }
    return {
...
export function ProjectTaskProgressReportToJSONTyped(value?: ProjectTaskProgressReport | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
