...
export function ClubMemberRecordFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClubMemberRecord {
    if (json == null) {
        return json;
    }
    return {
...
export function ClubMemberRecordToJSONTyped(value?: ClubMemberRecord | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
