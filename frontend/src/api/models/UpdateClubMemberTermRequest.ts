...
export type UpdateClubMemberTermRequestMemberStatusEnum = typeof UpdateClubMemberTermRequestMemberStatusEnum[keyof typeof UpdateClubMemberTermRequestMemberStatusEnum];


/**
 * Check if a given object implements the UpdateClubMemberTermRequest interface.
 */
export function instanceOfUpdateClubMemberTermRequest(value: object): value is UpdateClubMemberTermRequest {
...
export function UpdateClubMemberTermRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateClubMemberTermRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateClubMemberTermRequestToJSONTyped(value?: UpdateClubMemberTermRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
