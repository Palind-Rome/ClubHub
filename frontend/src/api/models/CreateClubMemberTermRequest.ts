...
export type CreateClubMemberTermRequestMemberStatusEnum = typeof CreateClubMemberTermRequestMemberStatusEnum[keyof typeof CreateClubMemberTermRequestMemberStatusEnum];


/**
 * Check if a given object implements the CreateClubMemberTermRequest interface.
 */
export function instanceOfCreateClubMemberTermRequest(value: object): value is CreateClubMemberTermRequest {
...
export function CreateClubMemberTermRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateClubMemberTermRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateClubMemberTermRequestToJSONTyped(value?: CreateClubMemberTermRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
