...
export function UserMembershipSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): UserMembershipSummary {
    if (json == null) {
        return json;
    }
    return {
...
export function UserMembershipSummaryToJSONTyped(value?: UserMembershipSummary | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
