...
export type ReviewProjectRequestProjectStatusEnum = typeof ReviewProjectRequestProjectStatusEnum[keyof typeof ReviewProjectRequestProjectStatusEnum];
...
export function ReviewProjectRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReviewProjectRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function ReviewProjectRequestToJSONTyped(value?: ReviewProjectRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
