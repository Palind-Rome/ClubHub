...
export function instanceOfUserSummary(value: object): value is UserSummary {
    ...
    if (!('canSubmitClubApplication' in value) || value['canSubmitClubApplication'] === undefined) return false;
    if (!('canReviewClubApplication' in value) || value['canReviewClubApplication'] === undefined) return false;
    return true;
}
