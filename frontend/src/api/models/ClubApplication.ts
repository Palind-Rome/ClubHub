...
export type ClubApplicationAuditStatusEnum = typeof ClubApplicationAuditStatusEnum[keyof typeof ClubApplicationAuditStatusEnum];
...
export function ClubApplicationFromJSONTyped(json: any, ignoreDiscriminator: boolean): ClubApplication {
    if (json == null) {
        return json;
    }
    return {
...
export function ClubApplicationToJSONTyped(value?: ClubApplication | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
