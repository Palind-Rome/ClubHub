 ...
 */
export function instanceOfUpdateClubProfileRequest(value: object): value is UpdateClubProfileRequest {
...
export function UpdateClubProfileRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateClubProfileRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateClubProfileRequestToJSONTyped(value?: UpdateClubProfileRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
